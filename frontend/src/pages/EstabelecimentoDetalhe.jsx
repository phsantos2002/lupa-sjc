    ...
    <div className="max-w-3xl mx-auto bg-white min-h-screen">
      ...
      <div className="px-4 -mt-10 relative">
        <div className="flex items-end gap-3">
          <div className="w-20 h-20 rounded-2xl bg-white shadow-lg border-2 border-lupa-gold/20 flex items-center justify-center overflow-hidden shrink-0">
            {est.logo_url ? (
              <img src={est.logo_url} alt="" className="w-full h-full object-cover" />
            ) : (
              <span className="text-lupa-gold font-display text-2xl">{est.nome?.charAt(0)}</span>
            )}
          </div>
