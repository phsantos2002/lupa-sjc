...
function PromoCard({ promo, onSelect }) {
  ...
  return (
    <button onClick={onSelect} className="bg-white rounded-xl border border-gray-100 overflow-hidden card-hover text-left w-full flex min-h-[128px]">
      {/* Photo left */}
      <div className="w-32 shrink-0 bg-tauste-blue">
        {promo.imagem_url ? (
