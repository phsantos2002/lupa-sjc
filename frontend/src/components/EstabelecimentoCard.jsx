    ...
    <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 card-hover shadow-sm">
      ...
      <Link to={`/estabelecimento/${est.slug}`} className="block relative h-36 bg-tauste-blue overflow-hidden">
        ...
        {(est.verificado || est.destaque) && (
          <span className="absolute bottom-2.5 right-2.5 px-2 py-0.5 bg-lupa-gold text-lupa-black text-[9px] font-bold rounded-full flex items-center gap-0.5">
      ...
      <div className="p-3.5">
        ...
        <div className="flex gap-2 mt-3">
          ...
          {whatsLink && (
            <a href={whatsLink} target="_blank" rel="noopener" onClick={e => e.stopPropagation()} className="py-2 px-3 bg-green-500 text-white text-[11px] font-bold rounded-lg flex items-center gap-1 hover:bg-green-600 transition">
