...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-lupa-black border-t border-gray-800 z-50 safe-bottom">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex flex-col items-center gap-0.5 px-3 py-1 text-[10px] font-medium transition-colors ${
                isActive ? 'text-lupa-gold' : 'text-gray-500 hover:text-gray-300'
              }`
            }
          >
            {item.icon}
